...
router.get("/", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al obtener usuarios ❌", details: err });
  }
});
...
router.get("/:id", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al obtener usuario ❌", details: err });
  }
});
...
router.put("/:id", async (req, res) => {
  try {
    ...
    res
      .status(400)
      .json({ error: "Error al actualizar usuario ❌", details: err });
  }
});
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al eliminar usuario ❌", details: err });
  }
});
